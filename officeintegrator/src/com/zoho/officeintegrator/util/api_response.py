...
class APIResponse(object):
    ...
    def __init__(self, headers, status_code, object, response_json):
    ...
    def get_response_json(self):
        """
        This is a getter method to get API response_json

        Returns:
            dict: A dict representing the API response_json
        """
